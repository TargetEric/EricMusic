<h1 align="center">🎵 Eric Music Bot 🎵</h1>

<h2 align="center">This Repo Will Not Work If You Didn't WhitList Your Vps Ip.</h2>

<h3 align="center">For Ip WhitListing Contact @TargetEric</h3>
...
1. **Fork the Repository**: Fork this repository to your GitHub account. Note: Edit Only nessary things.
2. **Contact**: Dm [TargetEric](https://t.me/TargetEric) to get whitlist your ip.
4. **No Cookies**: This Repo Not Works On cookies
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/TargetEric/EricMusic && cd EricMusic
   ```
